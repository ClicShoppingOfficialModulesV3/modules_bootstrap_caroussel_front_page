 ...
 */
  ...
  class fp_bootstrap_caroussel {
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_bootstrap_caroussel_caroussel_title');
      $this->description = CLICSHOPPING::getDef('module_bootstrap_caroussel_caroussel_description');

      if ( defined('MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_STATUS')) {
        $this->sort_order = MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_SORT_ORDER;
        $this->enabled = (MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_STATUS == 'True');
      }
    }
    ...
    public function execute() {
      ...
      if (empty($CLICSHOPPING_Category->getPath())) {
        ...
        $content_width = (int)MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_CONTENT_WIDTH;
        ...
        if ($CLICSHOPPING_Customer->getCustomersGroupID() == 0) {
          ...
          $Qbanners = $CLICSHOPPING_Db->prepare('select banners_url,
                                                   ...
                                                   ');
          $Qbanners->bindValue(':banners_group', HTML::outputProtected(MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_BANNER_GROUP));
        ...
        if ($Qbanners->rowCount() > 0 ) {
          ...
          $footer_tag .= '<script>';
          $footer_tag .= '$(document).ready(function(){ ';
          $footer_tag .= '$("#myCarouselHeaderBoostrapCaroussel").carousel({ ';
          $footer_tag .= 'interval : ' . ( int )MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_FADE_TIME . ', ';
          $footer_tag .= 'pause: false ';
          $footer_tag .= '}); ';
          $footer_tag .= '}); ';
          $footer_tag .= '</script>' . "\n";
          ...
          $indicators .= ' <div id="myCarouselHeaderBoostrapCaroussel" class="carousel slide" data-ride="carousel">';
          ...
          while ($banner = $Qbanners->fetch()) {
            $indicators .= '  <li data-target="#myCarouselHeaderBoostrapCaroussel" data-slide-to="' . $counter . '"' . ($counter == 0 ? ' class="active"' : '') . '></li>';
          ...
          ob_start();
          require_once($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/bootstrap_caroussel_caroussel'));
    ...
    public function check() {
      return defined('MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          'configuration_title' => 'Enable Banner Boostrap Caroussel ?',
          'configuration_key' => 'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_CONTENT_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_FADE_TIME',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_HOLD_TIME',
          'configuration_value' => '4000',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_BANNER_GROUP',
          'configuration_value' => SITE_THEMA.'_banner_boostrap_front_page',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_SORT_ORDER',
    ...
    public function keys() {
      return array(
                   'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_STATUS',
                   'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_CONTENT_WIDTH',
                   'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_BANNER_GROUP',
                   'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_FADE_TIME',
                   'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_HOLD_TIME',
                   'MODULE_BOOTSTRAP_CAROUSSEL_CAROUSSEL_SORT_ORDER'
                  );
    }
  }
